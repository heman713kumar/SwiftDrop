...
import { ServiceCategory, ServiceType, Store, MenuItem } from './types.ts';
import { FoodIcon, GroceryIcon, PharmacyIcon, PackageIcon, DocumentIcon, HeavyItemIcon, TruckIcon, BuildingStorefrontIcon } from './components/icons.tsx';
