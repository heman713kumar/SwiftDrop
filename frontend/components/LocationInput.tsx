...
import { fetchPlaceSuggestions } from '../services/geminiService.ts';
import { getCurrentPosition } from '../services/geolocationService.ts';
import { LocationInfo, MapSuggestion } from '../types.ts';
import { MapPinIcon, MyLocationIcon } from './icons.tsx';
