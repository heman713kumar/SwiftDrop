...
import { AppStep, OrderDetails, ServiceCategory, LocationInfo, PackageDetails, Store, UserProfile, PriceBreakdown, MovingDetails, BusinessLogisticsDetails, DeliveryTier } from './types';
...
import EmailRegistrationStep from './components/steps/EmailRegistrationStep';
import ServiceSelectionStep from './components/steps/ServiceSelectionStep';
import StoreSelectionStep from './components/steps/StoreSelectionStep';
import LocationInputStep from './components/steps/LocationInputStep';
